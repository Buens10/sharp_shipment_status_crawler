...
ort1 = db.dhl_shipment_events.find({}, {"events[1]": 1, "ort": 1})
ort2 = db.dhl_shipment_events.find({}, {"events[2]": 1, "ort": 1})
print(ort2)

ort1_2 = list(zip(ort1, ort2))
#ort1_2.sort(key=lambda x: x[1])
#print(ort1_2)
